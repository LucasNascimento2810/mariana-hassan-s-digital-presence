        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          <div className={`transition-all duration-800 delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            <p className="font-body text-base text-muted-foreground leading-relaxed mb-4">
              A saúde digestiva exige atenção, diagnóstico preciso e um plano de tratamento individualizado. Aqui,
              cada decisão é médica, e cada etapa é conduzida com responsabilidade e cuidado.
            </p>
            <p className="font-body text-base text-muted-foreground leading-relaxed mb-8">
              Recebo pacientes que buscam alívio para sintomas como azia, refluxo, dor abdominal e outros problemas
              digestivos. Juntos, encontramos o melhor caminho para a sua saúde.
            </p>
            <a
              href={WHATSAPP_URL}
              target="_blank"
