...
const faqs = [
  {
    ...
    answer:
      "A pedra na vesícula é a formação de cálculos biliares na vesícula biliar, devido a um desequilíbrio nas substâncias presentes na bile. Já a pedra nos rins refere-se à formação de cálculos nos rins. Os cálculos biliares são compostos principalmente de colesterol ou bilirrubina, enquanto os cálculos renais podem ser compostos de cálcio, ácido úrico, estruvita ou cistina.",
  },
  {
    question: "A laparoscopia é segura?",
    answer:
      "Sim, a laparoscopia é considerada uma técnica segura quando realizada por profissionais qualificados. Ela oferece vários benefícios em comparação com a cirurgia aberta tradicional, incluindo melhor precisão e uma análise mais detalhada da região operada.",
  },
  {
    question: "Quanto tempo dura a cirurgia por laparoscopia?",
    answer:
      "Em média, a cirurgia laparoscópica costuma levar de 1 a 2 horas para ser concluída. A duração pode variar de acordo com a complexidade do caso e a experiência do cirurgião.",
  },
  {
    question: "Qual é o tempo de recuperação após a cirurgia?",
    answer:
      "A maioria dos pacientes se recupera totalmente dentro de algumas semanas. Em até 2 semanas, o paciente geralmente volta para suas atividades rotineiras. É importante seguir as orientações médicas.",
  },
  {
    question: "É possível ter uma vida normal sem a vesícula biliar?",
    answer:
      "Sim, a vesícula biliar não é um órgão essencial para a sobrevivência. Após a remoção, a maioria dos pacientes pode levar uma vida normal, seguindo uma dieta saudável e equilibrada.",
  },
];
